...
--
-- Host: localhost:3306
-- Generation Time: Jul 18, 2018 at 08:18 AM
...
(307, 'agen069', 0, 0, 0, 165),
(308, 'agen024', 350000, 0, 0, 1005),
...
(54, 850, '2018-07-13', 5679970, 254970),
(55, 851, '2018-07-13', 16269500, 550250),
...
(60, 856, '2018-07-14', 14071700, 9121700),
...
(72, 868, '2018-07-16', 325000, 325000),
(73, 869, '2018-07-16', 225000, 225000),
(74, 870, '2018-07-16', 2192500, 152250),
(75, 871, '2018-07-16', 2217500, 0),
(76, 872, '2018-07-16', 6552040, 1552040),
...
(54, '2018-07-13', 2779970, 2525000, 254970, 78, 'mandiri 13 juli 2,525,000', 'admin003', 0),
(55, '2018-07-13', 16269500, 350000, 15919500, 79, 'bonus pembelian 2018-07-13', 'admin003', 1),
(55, '2018-07-13', 15919500, 16469750, 550250, 80, 'mandiri 13 juli 16,469,750', 'admin003', 0),
...
(60, '2018-07-14', 13771700, 4650000, 9121700, 85, 'mandiri 14 juli 4,650,000', 'admin003', 0),
...
(76, '2018-07-16', 6552040, 5000000, 1552040, 104, 'bca 16 juli 5jt', 'admin003', 0),
...
(868, 'agen015', '2018-07-16', 10, 325000, 'tidak ada', 'admin003', 0),
(869, 'agen015', '2018-07-16', 5, 225000, 'tidak ada', 'admin003', 0),
...
--
ALTER TABLE `bonus`
  MODIFY `kode_bonus` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=319;

--
-- AUTO_INCREMENT for table `bonus_detail`
--
ALTER TABLE `bonus_detail`
  MODIFY `kode_bonus_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=437;

--
-- AUTO_INCREMENT for table `history_delete`
--
ALTER TABLE `history_delete`
  MODIFY `kode_delete` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `log`
--
ALTER TABLE `log`
  MODIFY `kode_login` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;
...
--
ALTER TABLE `pembayaran_detail`
  MODIFY `kode_pembayaran_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT for table `pembelian`
--
ALTER TABLE `pembelian`
  MODIFY `kode_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=874;

--
-- AUTO_INCREMENT for table `pembelian_detail`
--
ALTER TABLE `pembelian_detail`
  MODIFY `kode_pembelian_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=623;

--
-- AUTO_INCREMENT for table `saldo`
--
ALTER TABLE `saldo`
  MODIFY `kode_saldo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=623;
